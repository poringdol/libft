...
// 	char s3_1[20] = {0};
// 	char s3_2[20] = {0};
// 	char *str = "proverka strlcpy";

// 	strlcpy(s1_1, str, 8);						// dst < n, dst < src, n < src
// 	ft_strlcpy(s1_2, str, 8);
// 	if (memcmp(s1_1, s1_2, 5)) {
// 		marker = 0;
// 		printf("\tFAIL ft_strlcpy: For dst size = 5, n = 8 expected '%s', received '%s'\n", s1_1, s1_2);
// 	}
// 	memset(s1_1, 0, 5);
// 	memset(s1_2, 0, 5);

// 	strlcpy(s1_1, str, 20);						// dst < n, dst < src, n > src
// 	ft_strlcpy(s1_2, str, 20);
// 	if (memcmp(s1_1, s1_2, 5)) {
// 		marker = 0;
// 		printf("\tFAIL ft_strlcpy: For dst size = 5, n = 20 expected '%s', received '%s'\n", s1_1, s1_2);
// 	}
// 	memset(s1_1, 0, 5);
// 	memset(s1_2, 0, 5);

// 	strlcpy(s3_1, str, 25);						// dst < n, dst > src, n > src
// 	ft_strlcpy(s3_2, str, 25);
// 	if (memcmp(s3_1, s3_2, 25)) {
// 		marker = 0;
// 		printf("\tFAIL ft_strlcpy: For dst size = 20, n = 25 expected '%s', received '%s'\n", s3_1, s3_2);
// 	}
// 	memset(s3_1, 0, 20);
// 	memset(s3_2, 0, 20);

// 	strlcpy(s2_1, str, 8);						// dst > n, dst < src, n < src
// 	ft_strlcpy(s2_2, str, 8);
// 	if (memcmp(s2_1, s2_2, 8)) {
// 		marker = 0;
// 		printf("\tFAIL ft_strlcpy: For dst size = 10, n = 8 expected '%s', received '%s'\n", s2_1, s2_2);
// 	}
// 	memset(s2_1, 0, 10);
// 	memset(s2_2, 0, 10);

// 	strlcpy(s3_1, str, 8);						// dst > n, dst > src, n < src
// 	ft_strlcpy(s3_2, str, 8);
// 	if (memcmp(s3_1, s3_2, 8)) {
// 		marker = 0;
// 		printf("\tFAIL ft_strlcpy: For dst size = 20, n = 8 expected '%s', received '%s'\n", s3_1, s3_2);
// 	}
// 	memset(s3_1, 0, 20);
// 	memset(s3_2, 0, 20);

// 	strlcpy(s3_1, str, 18);						// dst > n, dst > src, n > src
// 	ft_strlcpy(s3_2, str, 18);
// 	if (memcmp(s3_1, s3_2, 18)) {
// 		marker = 0;
// 		printf("\tFAIL ft_strlcpy: For dst size = 20, n = 18 expected '%s', received '%s'\n", s3_1, s3_2);
// 	}
// 	memset(s3_1, 0, 20);
// 	memset(s3_2, 0, 20);
...
/************** isalpha digit alnum ascii print ***************/
